...
<body>
                        ...
                        <ul class="list-unstyled li-space-lg p-small">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body"><a class="white"
                                        href="mailto:contact@I FIT YOU.com">contact@I FIT YOU.com</a> <i
                                        class="fas fa-globe"></i><a class="white" href="#your-link">www.I FIT YOU.com</a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <!-- Scripts -->
    <script src="/group5/js/jquery.min.js"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
