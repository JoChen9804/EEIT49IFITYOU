							...
							<div class="col-lg-7">
								<div class="p-5">
									...
									<form class="user">
										...
										<a href="login.html"
											class="btn btn-primary btn-user btn-block" style="text-decoration: none;"> Register
											Account </a>
										<hr>
										<a href="index.html" class="btn btn-google btn-user btn-block" style="color: #fff; background-color: #ea4335; border-color: #fff; text-decoration: none;">
											<i class="fab fa-google fa-fw"></i> Register with Google
										</a> <a href="index.html" style="color: #fff; background-color: #3b5998; border-color: #fff; text-decoration: none;"
