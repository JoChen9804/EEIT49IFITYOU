		...
		<ul
				...
				<div id="collapseActivities" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item"
							href="/group5/admin/activitymain.controller"
							style="font-size: 1.2rem; font-weight: 550;">活動管理</a> <a
							class="collapse-item" href="/group5/admin/vouchermain.controller"
							style="font-size: 1.2rem; font-weight: 550;">優惠券管理</a>
					</div>
				</div></li>
			<!-- Nav Item - Pages Collapse Menu æå¡ç®¡ç-->
			<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapseProducts" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item"
							href="/group5/admin/commodity_administration"
							style="font-size: 1.2rem; font-weight: 550;">商品管理</a>
					</div>
				</div></li>
			<!-- Nav Item - Pages Collapse Menu æå¡ç®¡ç-->
			<li class="nav-item"><a class="nav-link collapsed" href="#"
