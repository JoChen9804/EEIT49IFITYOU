	  ...
	  $('#show').html(`
			...
			<td>
				...
				<button type="button" class="btn btn-primary adddone1" 
		    		data-bs-toggle="modal" data-bs-target="#addone" >修改</button>
			...
			<form action="ddel" method="get">
			    ...
			    <button type="subbmit" class="btn btn-primary del" 
		    		data-bs-toggle="modal">刪除</button>
			</form>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="staticBackdropLabel">現在修改 !<span id="updateTitle"></span></h5>
				...
				<div class="modal-body">
					...
					<div class="input-group mb-3">
						...
						<div class="input-group mb-3">
							...
							<input type="hidden" name="exrid" value=""
															id="exrid" class="exrid"
															class="form-control">
													</div>
							...
							<div class="input-group mb-3">
								...
								<input type="text" name="setcount" class="setcount" placeholder="填新組數" id="setcount" class="form-control">
							</div>
							
							<div class="input-group mb-3">
								<label class="input-group-text" for="killoocount">重量：</label>
								<input type="text" name="killoocount" class="killoocount" placeholder="填新重量" id="killoocount" class="form-control">
							</div>
							
								<div class="input-group mb-3">
								<label class="input-group-text" for="times">次數：</label>
								<input type="text" name="times" class="times" placeholder="填新次數" id="times" class="form-control">
							</div>
							
									<div class="input-group mb-3">
								<label class="input-group-text" for="continutedtime">持續時間：</label>
								<input type="text" name="continutedtime" class="continutedtime" placeholder="新持續時間" id="continutedtime" class="form-control">
							</div>
							
									<div class="input-group mb-3">
								<label class="input-group-text" for="breaktime">休息間隔：</label>
								<input type="text" name="breaktime" class="breaktime" placeholder="新休息時間" id="breaktime" class="form-control">
							</div>
					...
					<button type="submit" class="btn btn-secondary" data-bs-dismiss="modal" id="submitUpdate">OK!</button>
